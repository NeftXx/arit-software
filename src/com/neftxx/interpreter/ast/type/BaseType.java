...
public class BaseType extends AritType {
    public static final BaseType INTEGER = new BaseType("integer", 10);
    public static final BaseType NUMERIC = new BaseType("numeric", 20);
    public static final BaseType BOOLEAN = new BaseType("boolean", 30);
